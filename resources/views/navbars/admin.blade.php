<nav class="navbar navbar-light navbar-glass navbar-top navbar-expand">
  ...
  <a class="navbar-brand me-1 me-sm-3" href="{{ route('index') }}">
    <div class="d-flex align-items-center"><img class="me-2" src="/assets/img/logo-100.png" alt="" width="40" /><span class="font-sans-serif">{{ config('app.name') }}</span>
    </div>
  </a>
  ...
  <ul class="navbar-nav navbar-nav-icons ms-auto flex-row align-items-center">
    ...
    <li class="nav-item dropdown"><a class="nav-link pe-0 ps-2" id="navbarDropdownUser" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
        <div class="avatar avatar-xl">
          <img class="rounded-circle" src="/storage/thumbnails/{{ Auth::user()->image }}" alt="" />
      ...
      <div class="dropdown-menu dropdown-menu-end py-0" aria-labelledby="navbarDropdownUser">
        <div class="bg-white dark__bg-1000 rounded-2 py-2">
          ...
          <a class="dropdown-item" href="{{ route('get_change_picture') }}">Picture</a>
          <a class="dropdown-item" href="{{ route('get_change_pwd') }}">Password</a>
          <div class="dropdown-divider"></div>
